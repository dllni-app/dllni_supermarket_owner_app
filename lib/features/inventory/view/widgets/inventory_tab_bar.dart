...
class InventoryTabBarItem {
  final String title;
  final int count;

  InventoryTabBarItem({required this.title, required this.count});
}
...
class InventoryTabBar extends StatefulWidget {
  ...
  final List<InventoryTabBarItem> items;
  final void Function(int index) onChanged;

  @override
  State<InventoryTabBar> createState() => _InventoryTabBarState();
}

class _InventoryTabBarState extends State<InventoryTabBar> {
  int selectedIndex = 0;
...
class _CategoryChip extends StatelessWidget {
  ...
  final InventoryTabBarItem item;
