...
AcceptOrderModelDataItemsItem acceptOrderModelDataItemsItemFromJson(str) => AcceptOrderModelDataItemsItem.fromJson(str);

String acceptOrderModelDataItemsItemToJson(AcceptOrderModelDataItemsItem data) => json.encode(data.toJson());


AcceptOrderModelDataItemsItemProduct acceptOrderModelDataItemsItemProductFromJson(str) => AcceptOrderModelDataItemsItemProduct.fromJson(str);

String acceptOrderModelDataItemsItemProductToJson(AcceptOrderModelDataItemsItemProduct data) => json.encode(data.toJson());
...
class AcceptOrderModelData {
  ...
  List<AcceptOrderModelDataItemsItem>? items;
  ...
  factory AcceptOrderModelData.fromJson(Map<String, dynamic> json) {
    return AcceptOrderModelData(
      ...
      items: json['items'] is List ? (json['items'] as List).whereType<Map>().map((item) => AcceptOrderModelDataItemsItem.fromJson(Map<String, dynamic>.from(item))).toList() : null,
...
class AcceptOrderModelDataItemsItem {
  int? id;
  int? orderId;
  int? productId;
  AcceptOrderModelDataItemsItemProduct? product;
  int? quantity;
  String? unitPrice;
  String? totalPrice;
  String? productName;
  ...
  factory AcceptOrderModelDataItemsItem.fromJson(Map<String, dynamic> json) {
    return AcceptOrderModelDataItemsItem(
      id: _asInt(json['id']),
      orderId: _asInt(json['orderId']),
      productId: _asInt(json['productId']),
      product: json['product'] is Map ? AcceptOrderModelDataItemsItemProduct.fromJson(Map<String, dynamic>.from(json['product'] as Map)) : null,
...
class AcceptOrderModelDataItemsItemProduct {
  int? id;
  int? storeId;
  int? categoryId;
  int? masterProductId;
  ...
  AcceptOrderModelDataItemsItemProduct({
    this.id,
    this.storeId,
    this.categoryId,
  ...
  factory AcceptOrderModelDataItemsItemProduct.fromJson(Map<String, dynamic> json) {
    return AcceptOrderModelDataItemsItemProduct(
      id: _asInt(json['id']),
      storeId: _asInt(json['storeId']),
