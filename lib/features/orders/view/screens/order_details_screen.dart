          ...
          Row(
            children: [
              CircleAvatar(
                ...
                child: Icon(_statusIcon(status), size: 22, color: AppColors.white),
              ),
              const SizedBox(width: 10),
              Expanded(
                child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Icon(Icons.notes_rounded, size: 18, color: Color(0xFF6B7280)),
                const SizedBox(width: 8),
                Expanded(
                  child: AppText(
                    specialInstructions,
      ...
      children: [
        Expanded(
          child: AppText(
            ...
            textAlign: TextAlign.start,
            style: TextStyle(
              color: isTotal ? const Color(0xFF111827) : const Color(0xFF4B5563),
